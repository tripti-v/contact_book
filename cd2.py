...
def DisplayForm():
    ...
    display_screen.geometry("700x400")

    display_screen.title("CodSoft Task 2")
    global tree
    global SEARCH
    ...
    lbl_txtsearch = Label(LeftViewForm, text="Enter fname to Search", font=('verdana', 10),bg="yellow")
    lbl_txtsearch.pack()
